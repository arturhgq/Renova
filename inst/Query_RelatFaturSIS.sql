/* RELATÓRIO DE FATURAMENTO - FLUXO ÁGIL */
...
FROM filtro_327
WHERE operadorinseriu IN (604830,725977,13685,310678,608036,726018,725690,725963,605437,725972,723822,611898,725970,
                            ...
                            571989,725958,615795,24016,308866,604898,283447,725979,619216,725680,615797,311090)
                             AND datainsercao BETWEEN '2022-03-21' AND '2022-04-20';
...
WHERE de_en IN ('Amanda Evelin da Silveira Carneiro','Ana Caroline de Jesus Santiago','Ana Luíza Macedo Ribeiro',
                                                ...
                                                'YURI ALVES DOS SANTOS') AND manifencaminhamentotipo_en != 'Retorno final dado'  AND data_en BETWEEN '2022-03-21' AND '2022-04-20';
...
WHERE responsavelconclusao IN ('Amanda Evelin da Silveira Carneiro','Ana Caroline de Jesus Santiago','Ana Luíza Macedo Ribeiro',
                                                ...
                                                'ROSIENNI REIS VIANELLO','Sarah Angélica Salomão Bruck','Simone Cristina de Brito','Stéfany Sidô Ventura','Tairon Junior Martins',
                                                'Tatiana Martins Mendes Silvestrow','Vanessa Alves Dias Silveira','Vera Lúcia de Sousa Golini','Walter Osvaldo Perez Vega',
                                                'YURI ALVES DOS SANTOS') AND dataconclusao BETWEEN '2022-03-21' AND '2022-04-20';